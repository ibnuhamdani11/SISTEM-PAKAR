...
<head>
		...
		<title>Sistem Pakar Diagnosa Penyakit Umum pada Balita Berbasis Web</title>
					...
					<!-- Navbar Collapse Starts -->
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav navbar-right">
								<!--  -->
									<!-- <li >
									<a href="login_mbr.php" class="dropdown-toggle" data-toggle="dropdown">
										Login 
									</a>
									
								</li> -->
								<li><a href="login_mbr.php">Login</a></li>
<!--  -->
		...
		<!-- Services Tab Starts -->
			...
			<!-- Nav Tabs Starts -->
				...
				<li>
					...
					<li>
						<a href="index.php?p=register&&act=add" >
							<div class="icon hidden-sm hidden-xs">
								<i class="glyphicon fa fa-fw fa-user-plus" width="50px"></i>
							</div>
							<h5>Register</h5>
						</a>
					</li>
		...
		<!-- Copyright Starts -->
			<div class="copyright">
				<div class="container clearfix">
					<p class="pull-left" align="center">
