        ...
        <div class="dataTable_wrapper">
          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            $posisi = $p->cariPosisi($batas);
                  $no = 0;
                  $query_tampil = mysqli_query($titid, "SELECT hasil_diagnosa.*,nm_penyakit FROM hasil_diagnosa, tabel_penyakit WHERE username='$_SESSION[username]' AND hasil_diagnosa.kode_penyakit= tabel_penyakit.kode_penyakit ORDER BY tanggal_diagnosa ASC limit $posisi, $batas");
                    (mysqli_error());
