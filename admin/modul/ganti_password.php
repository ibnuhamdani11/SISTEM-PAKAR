...
$session_id_admin= @$_SESSION['id_admin'];
// variable act
$simpan = @$_POST['simpan'];
...
if ($simpan) {
  if ($pass2!=$pass3) {
    ...
    $query = mysqli_query($titid, "SELECT * FROM admin WHERE password='$pass1' AND id_admin='$session_id_admin'") or die (mysqli_error());
    if(mysqli_num_rows($query)==1){
      mysqli_query($titid, "UPDATE admin SET password='$pass2' WHERE id_admin='$session_id_admin'") or die(mysqli_error());
      ?>
      <!-- pesan -->
      <script type="text/javascript">
