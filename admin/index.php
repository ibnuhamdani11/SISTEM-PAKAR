					...
					<!-- Navbar Collapse Starts -->
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="index.php?p=gejala&&act=read">Gejala</a></li>
								<li><a href="index.php?p=penyakit&&act=read">Penyakit</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="index.php?p=rule&&act=relasi">Relasi Gejala</a></li>
										<li><a href="index.php?p=bobot&&act=bobot_gejala">Bobot Gejala</a></li>
									</ul>
								</li>
								<!--  -->
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="index.php?p=gantipassword&username=<?php echo $_SESSION['username']; ?>">Ganti Password</a></li>
